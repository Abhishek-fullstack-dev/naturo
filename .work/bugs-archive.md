> ⚠️ ARCHIVED — All bugs migrated to GitHub Issues: https://github.com/AcePeak/naturo/issues
> This file is read-only historical reference. Do not edit.
...
## BUG-070 — --app 和 --window-title 应支持模糊匹配 🟡 Open
- **严重度**: 🟡 P1
- **来源**: 用户反馈 (Ace)
- **现象**: 必须精确输入完整标题才能匹配到窗口
- **期望行为**:
  1. 大小写不敏感：`--app Chrome` = `--app chrome`
